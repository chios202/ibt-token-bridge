...
const Bridge = () => {
  ...
  return (
    <div className="max-w-xl w-full bg-gray-800 rounded-xl p-6 shadow-xl">
      <h1 className="text-2xl font-bold text-center mb-6 text-white">IBT Token Bridge</h1>

      <div className="bg-gray-700 rounded-lg p-4 mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="w-full md:w-1/2 text-center">
          ...
          {currentAccount && (
            <p className="text-sm text-gray-300 mt-1">
              {formatDisplayAddress(currentAccount)}
            </p>
          )}
        </div>
      </div>
        ...
        <div className="bg-gray-700 p-4 rounded-lg flex justify-around">
          <label className="inline-flex items-center cursor-pointer">
            <input
              ...
              disabled={loading}
            />
            <span className="ml-2 text-gray-200">Ethereum → Sui</span>
          </label>
          <label className="inline-flex items-center cursor-pointer">
            <input
              type="radio"
              ...
              disabled={loading}
            />
            <span className="ml-2 text-gray-200">Sui → Ethereum</span>
          </label>
        </div>
